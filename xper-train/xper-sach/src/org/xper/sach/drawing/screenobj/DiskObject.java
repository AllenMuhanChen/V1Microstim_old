...
public class DiskObject implements Drawable {
	...
	public static float radius = 3.5f;//1.5f;			// when changing any static variable, you need to purge and recreate stimuli (so their targetPositions are correctly calculated)
	...
	public static double ty = 100; // 70;//80;		
